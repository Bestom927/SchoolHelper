# -*- coding: utf-8 -*-
"""
Created on Tue Dec 13 14:40:34 2022
...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 17 13:43:33 2022
...
from CNN_model import CNN, save_model, load_model
import torch
...
if __name__ == '__main__':
    ...
    cnn = CNN()
    cnn = train_model(cnn, data, label, lr=0.003, batch_size=500, epoch=500)
    save_model(cnn, "cnn.pkl")

    test_model(cnn, data, label)
 

    file = "{\"ielts\": {\"total\": \"7\", \"reading\": \" 7\", \"writing\": \"6\", \"speaking\": \"7\", \"listening\": \"7\"}, \"undergraduate\": {\"gpa\": \"79\", \"sid\": \"4\", \"year\": \"2023\", \"school\": \"双非\", \"subject\": \"工商管理\"}}"
